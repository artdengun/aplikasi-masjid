    ...
    <div class="container-fluid text-center">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo base_url('/daftarmarbot') ?>">Data marbot</a></li>
          <li class="breadcrumb-item" aria-current="page">Edit marbot</li>
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <?php echo form_label('Foto marbot', 'Image'); ?>
                    <br>
                    <img src="<?php echo base_url('uploads/marbot/' . $daftarmarbot['foto']) ?>" class="img-fluid">
                    <br>
                    <br>
                    <?php echo form_label('Ganti Image', 'Change foto'); ?> <br/>
                    <?php echo form_upload('foto', $daftarmarbot['foto']); ?>
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="form-group">
