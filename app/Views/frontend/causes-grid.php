...
<!-- Mirrored from www.webstrot.com/html/mosque/causes-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Jun 2021 18:17:41 GMT -->
                    ...
                    <div class="col-lg-5 col-md-3 col-sm-12 col-xs-12">
                        <div class="grid-list">
                            <ul class="list-inline">
                                ...
                                <li class="active"><a href="causes-grid.html"><i class="fa fa-th-large"></i></a></li>
                                <li><a href="causes-list.html"><i class="fa fa-th-list"></i></a></li>
                            </ul>
                        </div>
                    </div>
