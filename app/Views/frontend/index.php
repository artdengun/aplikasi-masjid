                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption one">
                                <div class="content">
                                    <img class="animated fadeInDown" src="<?php echo base_url('frontend/images/slider/sm-1.png'); ?>" alt="" />
                                    <h2 class="animated fadeInDown"><span class="primary">Allah</span> Help
                                        Those<br> Who Help <span class="hover">Themselves</span> </h2>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                <div class="video-thumb">
                    <figure>
                        <div class="thumbnail">
                            <img src="<?php echo base_url('frontend/images/video/1.jpg'); ?>" alt="" />
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="section-heading-two">
                    ...
                    <p>Denean sollicitudin. This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit
                        auctor aliquet. Aenean itudin. This is Photoshop's sion of Lorem Ipsum. Proin gravida nibh
                        vel velit.</p>
                </div>
            </div>
        </div>
            ...
            <div class="causes-slider">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="causes-list">
                        <figure><img src="<?php echo base_url('frontend/images/causes/1.jpg'); ?>" alt="" /></figure>
                        <div class="content">
                            <span class="date"><i class="fa fa-calendar-o"></i>20 Aug 2017</span>
                            <h4><a href="#">Childrens Teaching</a></h4>
                            <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin.<a href="#">read
                                    more</a></p>
                            <div class="donate">
                                <div class="dnl">
                                    <span>$</span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="causes-list">
                        <figure><img src="<?php echo base_url('frontend/images/causes/2.jpg'); ?>" alt="" /></figure>
                        <div class="content">
                            <span class="date"><i class="fa fa-calendar-o"></i>20 Aug 2017</span>
                            <h4><a href="#">Childrens Teaching</a></h4>
                            <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin.<a href="#">read
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="causes-list">
                        <figure><img src="<?php echo base_url('frontend/images/causes/3.jpg'); ?>" alt="" /></figure>
                        <div class="content">
                            <span class="date"><i class="fa fa-calendar-o"></i>20 Aug 2017</span>
                            <h4><a href="#">Childrens Teaching</a></h4>
                            <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin.<a href="#">read
                            ...
                            <div class="col-sm-7 col-xs-12 pd-0">
                                <div class="content">
                                    ...
                                    <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin. This is
                                        Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor
                                        aliquet. Aenean Morbi. <a href="#">Read More</a></p>
        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
                <div class="content pd-l40">
                    ...
                    <p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin. This is Phoshop's version.
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="testimonial-slider">
                    <div class="testimonial-list">
                        <blockquote>“Omnis iste natus error sit voluptatem accusantium doloremque laudantium totam
                            remia situa anti aperiam. Proin gravida nibh vel velit auctor.”</blockquote>
