...
<!-- all js here -->
<script src="<?php echo base_url('frontend/js/vendor/jquery-1.12.0.min.js'); ?>"></script>
<script src="<?php echo base_url('frontend/js/tether.min.js'); ?>"></script>
...
<script src="<?php echo base_url('frontend/js/jquery.meanmenu.js'); ?>"></script>
<script src="<?php echo base_url('frontend/js/jarallax.min.js'); ?>"></script>
...
<script src="<?php echo base_url('frontend/js/plugins.js'); ?>"></script>
<script src="<?php echo base_url('frontend/js/contact_form.js'); ?>"></script>
...
<script>
    function initialize() {
        ...
        var map = new google.maps.Map(document.getElementById('map'),
            mapOptions);
        var image = 'frontend/images/icon/map-marker.png';
