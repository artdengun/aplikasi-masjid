...
<!-- Mirrored from www.webstrot.com/html/mosque/gallery-col-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Jun 2021 18:18:11 GMT -->
...
<head>
    ...
    <body>
        ...
        <section class="gallery-area section2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row" id="Container">
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mix azha milad">
                        <div class="gallery">
                            <figure>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mix ashura fitr">
                        <div class="gallery">
                            <figure>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mix azha ramdan">
                        <div class="gallery">
                            <figure>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mix milad ashura">
                        <div class="gallery">
                            <figure>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mix milad fitr">
                        <div class="gallery">
                            <figure>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mix ashura ramdan">
                        <div class="gallery">
                            <figure>
...
<!-- Mirrored from www.webstrot.com/html/mosque/gallery-col-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Jun 2021 18:18:16 GMT -->
</html>
