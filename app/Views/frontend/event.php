...
<!-- Mirrored from www.webstrot.com/html/mosque/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Jun 2021 18:18:11 GMT -->
...
<head>
    ...
    <body>
        ...
        <header>
            ...
            <div class="mobile-menu-area page event">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
        ...
        <section class="event-area-page section">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pd-r0 mr-b30">
                        <div class="event-list-right">
                            <div class="row mr-r0">
                                <div class="col-sm-5 pd-r0">
                                    <div class="event-img">
