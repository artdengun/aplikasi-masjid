        ...
        <div class="container-fluid  text-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Data muazin</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="<?php echo base_url('daftarmuazin/create'); ?>" class="btn btn-primary float-right">Tambah Pengurus</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($daftarmuazin as $row) { ?>
                                        <tr>
                                            ...
                                            <td><img src="<?= base_url('uploads/muazin/' . $row['foto']) ?>" class="rounded-circle" width="50" height="50"></td>
