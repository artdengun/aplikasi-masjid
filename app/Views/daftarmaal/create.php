    ...
    <div class="container-fluid text-center">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item" aria-current="page">Tambah Data maal</li>
        </ol>
      </nav>
    </div>
  </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          ...
          <?php } ?>
          <?php echo form_open_multipart('daftarmaal/store'); ?>
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <?php
                    echo form_label('Alamat Rumah maal');
                    $alamat = [
                      'type'  => 'text',
                      'name'  => 'alamat',
                      'id'    => 'alamat',
                      'value' => $inputs['alamat'],
                      'class' => 'form-control',
                      'placeholder' => 'Masukan alamat maal'
                    ];
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <?php
                    echo form_label('Tahun maal Terdata');
                    $tahun = [
                      'type'  => 'date',
                      'name'  => 'tahun',
                      'id'    => 'tahun',
                  ...
                  <div class="form-group">
                    <?php
                    echo form_label('Status Keaktifan maal', 'Status');
