        ...
        <div class="container-fluid  text-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Data maal</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <a href="<?php echo base_url('daftarmaal/create'); ?>" class="btn btn-primary float-right">Tambah maal</a>
                                    ...
                                    <?php foreach ($daftarmaal as $row) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url('daftarmaal/edit/' . $row['idmaal']); ?>" class="btn btn-sm btn-success">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="<?php echo base_url('daftarmaal/delete/' . $row['idmaal']); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus Data ini?');">
